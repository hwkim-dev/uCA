...
rebuilt.  The previous revision built its two citation
...
The page will be rebuilt from scratch when:
...
At that point the two tables reappear here, produced by whichever
