...
\author{%
  ...
  \small \url{https://pccxai.github.io/pccx/}
}
...
supplies 16 built-in trace analyzers and a UVM strategy workflow facade.
This preprint covers the architecture, the Sail model, the
...
\begin{itemize}
  ...
  \item \texttt{WorkflowFacade::investigate} / \texttt{suggest\_fix} surface.
...
\url{https://pccxai.github.io/pccx/en/docs/quickstart.html}.
...
\begin{itemize}
  ...
  \item Post-route timing evidence for the 400~MHz core / 250~MHz AXI targets.
...
\url{https://pccxai.github.io/pccx/en/docs/Evidence/index.html}.
