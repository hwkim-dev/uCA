...
행렬 곱셈을 담당합니다. pccx v002 는 **32 × 32 2 차원 시스톨릭 어레이
1 개** 를 사용하며, 누적 cascade 가 16 행에서 끊겨 같은 물리 격자를
공유하는 **32 × 16** 서브체인 2 개로 동작하여 이론 피크
**819 GMAC/s @ 400 MHz** 를 제공합니다.
...
KV260 기준 32 × 32 격자는 **DSP48E2 슬라이스 1,024 개** 를 사용하여
