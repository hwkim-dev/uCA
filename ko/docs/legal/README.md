...
본 문서는 PCCX의 legal / IP / commercial 문서 집합을 한 눈에 보는 맵이다.
각 문서는 최종적인 법률 조언도, 계약서도 아니다. 구속력 있는 판단은
원문 라이선스와 각 계약의 최종 버전, 그리고 자격을 갖춘 법률 자문을 근거로 한다.
...
- [`../ip/madrid-priority-docket.md`](../ip/madrid-priority-docket.md) — 대외
  출원 윈도우 요약
...
- [`../ip/source-header-inventory.md`](../ip/source-header-inventory.md) — SPDX
  헤더 적용 현황
- [`../ip/copyright-registration-candidates.md`](../ip/copyright-registration-candidates.md) — 추가 등록 후보
...
- [`../ip/trade-secret-policy.md`](../ip/trade-secret-policy.md) — 비공개 처리 원칙
- [`../ip/private-disclosure-boundary.md`](../ip/private-disclosure-boundary.md) — 공개 금지 항목 경계
