   ...
   .. grid-item::
      ...
      .. grid:: 1
         ...
         .. grid-item-card:: :octicon:`telescope;1em;sd-mr-1` pccx-lab (검증 / 프로파일)
            :link: https://pccx.pages.dev/ko/lab/
            :link-type: url
            ...
            **pccx-lab** — Tauri 2 IDE. ``.pccx`` 트레이스 로딩,
            ...
            Vivado synth 리포트 뷰.
            `검증 워크플로우 가이드 <https://pccx.pages.dev/ko/lab/verification-workflow.html>`_
...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: :octicon:`project-roadmap;1.2em;sd-mr-1` 설계 근거
      :link: https://pccx.pages.dev/ko/lab/design/rationale.html
      :link-type: url
...
.. toctree::
   ...
   pccx-lab — 시뮬레이터 & AI 프로파일러 <https://pccx.pages.dev/ko/lab/>
