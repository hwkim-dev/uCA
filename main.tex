...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south west, text=white, font=\sffamily\small]
    ...
    {Document Repository: \texttt{https://github.com/pccxai/pccx}};
...
The pccx web portal at \url{https://pccxai.github.io/pccx/}
...
\begin{itemize}[leftmargin=*, itemsep=0.2ex]
  \item \texttt{GEMM} --- prefill. Q/K/V projection, FFN up/down
        projection over a sequence tile.
...
\section{Example 1 --- Single GEMM tile (Q projection for one sequence tile)}
