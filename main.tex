...
\begin{tikzpicture}[
  font=\sffamily\scriptsize,
  leaf/.style={rectangle, draw=oceanblue, fill=oceanblue!10,
               minimum width=0.42cm, minimum height=0.42cm, inner sep=0pt},
  dsp/.style ={rectangle, draw=accentred, fill=accentred!15,
               minimum width=0.6cm, minimum height=0.5cm, inner sep=0pt,
               font=\sffamily\tiny\bfseries},
  lut/.style ={rectangle, draw=accentgreen, fill=accentgreen!15,
               minimum width=0.75cm, minimum height=0.5cm, inner sep=0pt,
               font=\sffamily\tiny\bfseries},
  sink/.style={rectangle, draw=accentpurple, fill=accentpurple!20,
...
\begin{tikzpicture}[
  ...
  state/.style = {circle, draw=oceanblue, thick, minimum size=1.7cm, align=center,
                  font=\sffamily\footnotesize, inner sep=1pt, fill=skytint},
  stateh/.style= {circle, draw=accentred, thick, minimum size=1.7cm, align=center,
                  font=\sffamily\footnotesize, inner sep=1pt, fill=skytint},
...
\begin{tikzpicture}
  \begin{loglogaxis}[
    ...
    \addplot[domain=0.1:100, samples=2, thick, color=accentred]
      { 12.8 * x };
    \addlegendentry{Memory bound (12.8\,GB/s)}

    % Compute ceiling at 800 GMAC/s
    \addplot[domain=0.1:1000, samples=2, thick, color=accentgreen]
      { 800 };
    \addlegendentry{Compute peak (800\,GMAC/s)}

    % Operating points
    \addplot[only marks, mark=*, mark size=2.7pt, color=oceanblue]
      coordinates { (0.5, 6.4) };
    \addlegendentry{GEMV (AI $\approx$ 0.5)}

    \addplot[only marks, mark=square*, mark size=2.7pt, color=oceanblue]
      coordinates { (256, 800) };
    \addlegendentry{GEMM (AI $\approx$ 256)}

    \addplot[only marks, mark=triangle*, mark size=3pt, color=accentpurple]
      coordinates { (2, 25.6) };
    \addlegendentry{CVO (AI $\approx$ 2)}

    % Ridge point annotation
    \addplot[dashed, thick, color=graytext] coordinates { (62.5, 1) (62.5, 800) };
